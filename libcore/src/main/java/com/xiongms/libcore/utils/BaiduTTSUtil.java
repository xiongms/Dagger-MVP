 ...
 *
 * 百度语音合成工具类
 * Created by 1 on 2018/7/4.
 */

public class BaiduTTSUtil {

    private static final String TAG = "BaiduTTSUtil";

    private static BaiduTTSUtil mBaiduTTSUtil = null;

    public static BaiduTTSUtil getInstance() {
        if (mBaiduTTSUtil == null) {
            mBaiduTTSUtil = new BaiduTTSUtil();
        }
        return mBaiduTTSUtil;
    }
     ...
     */
    protected String appId = "11475470";

    protected String appKey = "ilFseCnl2yBaqruDPX9HvFWe";

    protected String secretKey = "nMHt0huoHIAKYn50dmjBFuGGmqxquRHS";
