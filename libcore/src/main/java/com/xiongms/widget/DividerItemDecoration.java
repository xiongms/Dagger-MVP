...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public DividerItemDecoration(Drawable divider, RecyclerView recyclerView) {
        mDivider = divider;
    ...
    public void onDraw(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        if (parent.getLayoutManager() instanceof StaggeredGridLayoutManager) {
            mOrientation = ((StaggeredGridLayoutManager) parent.getLayoutManager()).getOrientation();
    ...
    private void drawHorizontalDividers(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount - 1; i++) {
            ...
            int parentTop = child.getTop();
            int parentBottom = child.getBottom();
    ...
    private void drawVerticalDividers(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount - 1; i++) {
            ...
            int parentLeft = child.getLeft();
            int parentRight = child.getRight();
