...
public class DateTimePicker {
    ...
    public DateTimePicker(Context context, Date startDate, Date endDate, Builder builder) {
        this(context, null, startDate, endDate, builder);
    }
...
//        ObjectAnimator.ofPropertyValuesHolder(view, pvhX, pvhY, pvhZ).setDuration(200).start();
    ...
    public void setSelectedTime(Date time) {
        ...
        if (curShowType.value >= ShowType.DAY.value) {
            ...
            } else if (y == startYear && m == startMonth) {
                for (int i = startDay; i <= selectedCalender.getActualMaximum(Calendar.DAY_OF_MONTH); i++) {
                    days.add(formatTimeUnit(i));
                }
    ...
    public static class Builder {
        ...
        public Builder(Context c) {
            ...
            segmentingLineColor = Color.WHITE;
            segmentingLineHeight = 1;
            showType = ShowType.MINUTE;
            keepLastSelected = false;
            showYMDHMLabel = false;
            loopScroll = false;
            startDate = null;
            endDate = null;
            maxTextSize = 48;
        ...
        public Builder setDividerWidth(float dividerWidth) {
        ...
        public Builder setTextSize(float max, float min) {
        ...
        public DateTimePicker build() {
            return new DateTimePicker(context, startDate, endDate, this);
        }
    }
}
